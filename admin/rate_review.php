   ...
   if(isset($_GET['seen']))
   {
      ...
      if(isset($frm_data['seen']) && $frm_data['seen'] =='all'){
         ...
         if(update($q,$values,'i')){
            alert('success','Marquer tout comme lu');
         }
         else{
            alert('error','Échec de l\'opération');
         }
      }
  ...
  <div class="container-fluid">
      <div class="row">
         <div class="col-lg-10 ms-auto p-4 overflow-hidden">
            <h3 class="mb-4"> Évaluations & Avis</h3>
               ...
               <div class="card-body">
                 ...
                 <div class="text-end mb-4">
                   ...
                   <a href="?del=all" class="btn btn-danger rounded-pill shadow-none btn-sm">
                     <i class="bi bi-trash"></i> Supprimer tous les lus
                  </a>
                 </div>
                       ...
                       <?php
                          ...
                          $i=1;
                           ...
                           while($row = mysqli_fetch_assoc($data))
                           {
                              ...
                              $seen='';
                              if($row['seen']!=1){
                                 $seen = "<a href='?seen=$row[sr_no]' class='btn btn-sm rounded-pill btn-primary mb-2'>Marquer comme lu</a><br>";
                              }
                              $seen.="<a href='?del=$row[sr_no]' class='btn btn-sm rounded-pill btn-danger'>Supprimer</a>";
                              echo<<<query
                              <tr>
                                 <td>$i</td>
                                 <td>$row[rname]</td>
