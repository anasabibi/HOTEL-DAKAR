...
<body class="bg-light">
    ...
    <div class="row">
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h5 class="card-title m-0">Fermer le Site</h5>  
                    ...
                    <p class="card-text">
                        Aucun client ne pourra réserver une chambre d'hôtel lorsque le mode arrêt est activé.
                    </p>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="mb-4">
                                <h6 class="card-subtitle mb-1 fw-bold">Numéros de Téléphone</h6>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                <h6 class="card-subtitle mb-1 fw-bold">Liens Sociaux</h6>
                                <p class="card-text mb-1">
                                ...
                                <div class="container-fluid p-0">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label fw-bold">Numéros de Téléphone (avec indicatif)</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label fw-bold">Liens Sociaux</label>
                                                <div class="input-group mb-3">
            ...
            <div class="card border shadow-sm mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h5 class="card-title m-0">Équipe de Direction</h5>
   ...
   <script Src="scripts/settings1.js"></script>
</body>
</html>