<?php
    ...
    function send_mail($uemail, $token,$type) 
    {
        if($type == "email_confirmation"){
            ...
            $subject = "Lien de vérification de compte";
            $content = "Veuillez confirmer votre adresse e-mail";
        }
        else{
            $page = 'index.php';
            $subject = "Lien de réinitialisation de compte";
            $content = "Réinitialisez votre compte";
        }
